ExternalProject_Add(libCharon
    ...
    GIT_SHALLOW 1
    STEP_TARGETS update
    CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${EXTERNALPROJECT_INSTALL_PREFIX} -DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH} -DPython3_EXECUTABLE="${CMAKE_PREFIX_PATH}/bin/python3.8"
)
